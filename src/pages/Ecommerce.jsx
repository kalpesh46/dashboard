...
import {PieChart, StackedChart, Button, SparkLineChart} from '../components/'
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern  bg-no-repeat bg-cover bg-center'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-2xl'>$64,488.78</p>
            </div>
          </div>
          <div className='mt-6'>
            <Button
            ...
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  ...
                  <span className='p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full bg-green-600 ml-3 text-xs'>23%</span>
                </p>
